...
if (isset($_GET["nome"])) {
  ...
  $sql = "SELECT * FROM profissionais WHERE nome LIKE '%$nome%'";
  ...
  if (empty($dados)) {
    echo "Nenhum barbeiro encontrado com o nome '$nome'.";
  }
} else {
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
      <form action="editarBarbeiroADM.php" method="GET">
        ...
        <div class="p-2">
          <label for="nome" class="form-label"> Digite o nome do barbeiro: </label>
      ...
      <div class="row">
        <div class="col-12">
          <table class="table table-dark">
            ...
            <?php
            foreach ($dados as $barbeiro) {
              $cpf = $barbeiro["cpf"];
              echo "<tr>";
              echo "<td> $cpf </td>";
              echo "<td> {$barbeiro["nome"]} </td>";
              echo "<td> {$barbeiro["email"]} </td>";
              echo "<td>";
              echo "<a href='editarBarbeiroADM.php?cpf=$cpf'><img class='mx-2 icone-config' src='imagens/config.png'></a>";
              echo "</td>";
              echo "</tr>";
            }
            ?>
