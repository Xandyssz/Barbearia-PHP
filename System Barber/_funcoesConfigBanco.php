 ...
 * @return type
 */
function conectarBanco($SYSB) { // Atencao: indique aqui conforme o BD que ira usar!
    $servidor    = "localhost"; 
    $usuario     = "root"; 
    $senha_mysql = "ifsp";
            
    // cria conexao
    $con = mysqli_connect($servidor, $usuario, $senha_mysql, $SYSB);

    // verifica se deu certo
    if (!$con) {
        echo "<h1>Falhou ao conectar ao bancoSYSB $SYSB no endereco $servidor </h1>";
        die();
    } else{
